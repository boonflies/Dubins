...
class PlotFrame(wx.Frame):
    ...
    def plot_data(self):
        ...
        if dimension == 'two':
            ...
            self.axes.plot(np.array(x_UAV), np.array(y_UAV),np.array(z_UAV),'-.b')
            if task == 'tracking':
                self.axes.plot(x_target, y_target, z_target, '-or')
...
class App(wx.App):
    def OnInit(self):
        ...
        image = wx.Image('./datafiles/different_type_obstacles.jpg', wx.BITMAP_TYPE_JPEG)
